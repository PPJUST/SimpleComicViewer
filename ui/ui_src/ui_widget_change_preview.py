...
################################################################################
## Form generated from reading UI file 'ui_widget_change_previewlcNFHe.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.toolButton_preview_double_reverse = QToolButton(Form)
        self.toolButton_preview_double_reverse.setObjectName(u"toolButton_preview_double_reverse")

        self.gridLayout.addWidget(self.toolButton_preview_double_reverse, 0, 2, 1, 1)

        self.toolButton_preview_h_reverse = QToolButton(Form)
        self.toolButton_preview_h_reverse.setObjectName(u"toolButton_preview_h_reverse")

        self.gridLayout.addWidget(self.toolButton_preview_h_reverse, 1, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.toolButton_preview_double_reverse.setText(QCoreApplication.translate("Form", u"2", None))
        self.toolButton_preview_h_reverse.setText(QCoreApplication.translate("Form", u"h", None))
    # retranslateUi
